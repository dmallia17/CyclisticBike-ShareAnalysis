...
# 6. Act
The act phase in this scenario consists of two items: (1) my top three
recommendations and (2) sharing this analysis with the wider world!

My recommendations are the following:

1. Collect survey data: a key question that needs to be answered here is if
casual riders have ever considered becoming a member and if so, why they have
not done so already? The above findings suggest there may already be many
casual riders who are a good fit, and this will give some key insight as to
whether it is a matter of awareness, pricing or perhaps another issue such as
unavailability of their favorite bike type. It would also be great to know
exactly why they are using a bike, such as for commuting to work.
2. Gather bike path information and conduct geographical analysis: by examining
ride patterns by location, insight may be gained into how much suitability for
bikes is influencing usage patterns as well as how awareness has perhaps not
grown in areas where stations are new.
3. Create a cost-benefit breakdown for users: The above two steps will help
identify the exact types of casual riders that may be influenced, and the areas
to focus efforts, but moving forward will require cost analysis that could
produce concrete recommendations in the form of "If you take X rides in a week,
you would save money by becoming a member!"

For sharing, this work will be hosted on
[my website](https://dmallia17.github.io) (there's a good chance that's how
you found it!), as a projects item linking to the repository and as a standalone
page showing this notebook in all its beauty.
